// Based on original LogiteckGSDK.cs by Logitech LEDSDK
...
public enum MyKey
{
    ...
    PRINT_SCR = 0x137,
    SCROLL_LK = 0x46,
    PAUSE_BRK = 0x145, // self: switched PAUSE_BREAK & NUM_LOCK (bug in SDK?)
    TILDE = 0x29,
    ONE = 0x02,
    TWO = 0x03,
    THREE = 0x04,
    ...
    OPEN_BRACK = 0x1A,
    CLOSE_BRACK = 0x1B,
    // BACKSLASH = 0x2B, // doesn't exist on FRA
    DELETE = 0x153,
    END = 0x14F,
    PAGE_DOWN = 0x151,
    NUM_SEVEN = 0x47,
    ...
    SEMICOLON = 0x27,
    APOSTROPHE = 0x28,
    MY_MUAST = 0x5D, // self added
    ENTER = 0x1C,
    NUM_FOUR = 0x4B,
    NUM_FIVE = 0x4C,
    NUM_SIX = 0x4D,
    LEFT_SHIFT = 0x2A,
    MY_GTLT = 0x56, // self added
    Z = 0x2C,
    X = 0x2D,
    C = 0x2E,
    V = 0x2F,
...
public class LogitechGSDK
{
    ...
    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedExcludeKeysFromBitmap(MyKey[] keyList, int listCount);
    ...
    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedSetLightingForKeyWithKeyName(MyKey keyCode, int redPercentage, int greenPercentage, int bluePercentage);

    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedSaveLightingForKey(MyKey keyName);

    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedRestoreLightingForKey(MyKey keyName);

    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedFlashSingleKey(MyKey keyName, int redPercentage, int greenPercentage, int bluePercentage, int msDuration, int msInterval);

    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedPulseSingleKey(MyKey keyName, int startRedPercentage, int startGreenPercentage, int startBluePercentage, int finishRedPercentage, int finishGreenPercentage, int finishBluePercentage, int msDuration, bool isInfinite);

    [DllImport("LogitechLedEnginesWrapper ", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiLedStopEffectsOnKey(MyKey keyName);
